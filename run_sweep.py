...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs", type=int, default=250, help="Maximum epochs per trial")
    parser.add_argument("--db", type=str, default="TEMP.db", help="Database filename for storing results")
